...
@Component({
  selector: 'app-laborbook-all',
  templateUrl: './laborbook-all.component.html',
  styleUrls: ['./laborbook-all.component.css']
})
export class LaborbookAllComponent {
